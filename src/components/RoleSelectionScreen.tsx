...
const RoleSelectionScreen: React.FC<{ onSelectRole: (role: Role) => void; }> = ({ onSelectRole }) => {
    return (
        <div className="flex-grow flex items-center justify-center p-4 bg-slate-50">
            <div className="w-full max-w-lg bg-white p-8 rounded-xl shadow-2xl text-center animate-fade-in">
                ...
                <p className="text-slate-600 mb-8">Por favor, selecciona tu rol para continuar.</p>
